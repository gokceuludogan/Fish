...
public class Client extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("search <expr>- Search shared files according to given regular expression");
    ...
    void execute(Command command) throws IOException, ClassNotFoundException, SQLException, InterruptedException {
        ...
        switch (command.getCommandName()) {
            ...
            case list: // If user wants to see all files avaiable, or search for a specific file: 
                ...
                System.out.println("name example - Search for files that have a specific name without extension.");
                ...
                System.out.println("max 500      - Search for files with maximum size (in KBytes).");
                ...
                //System.out.println("before file receiver: "+fileIP+" 8888 "+fileName );
                new FileReceiver(fileIP, 8888, fileName, fileSize).start();
                System.out.println("downloaded");
                break;
            case search:
                System.out.println("You can define what files you are looking for.");
